...
questions_list.append(
        Question('Сколько лет Жене?', '11', '2', '6', '12'))
questions_list.append(
        Question('Сколько лет маме?', 'Немного', '97', '60', '52'))
questions_list.append(
        Question('Сколько лет папе?', '60', 'Много', 'Немного', 'Не мало'))
questions_list.append(
        Question('Сколько лет Росе?', '3', '2', '1', '3.5'))
questions_list.append(
        Question('У кого есть телефоны?', 'Все', 'Папа и Женя', 'Серёжа Женя и Мама', 'Папа и Мама'))
questions_list.append(
        Question('Кто занимается музыкой?', 'Серёжа', 'Женя', 'Мама', 'Папа'))
questions_list.append(
        Question('Кто всегда опаздывает на ужин?', 'Папа', 'Мама', 'Женя', 'Серёжа'))
questions_list.append(
        Question('Кому больше 50 лет?', 'Папа', 'Серёжа', 'Женя', 'Мама'))
questions_list.append(
        Question('Кто из членов ведёт канал в ютубе?', 'Мама и Серёжа', 'Женя и Серёжа', 'Мама', 'Серёжа'))
...
window.setWindowTitle('Семейный квест')
